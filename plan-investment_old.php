...
<head>
	...
	<title>Plan Your Investment | Income Tax Return</title>	
...
<div class="body">
	...
	<div role="main" class="main">
		...
		<!--============ Plans your Investment Section Start ==============-->
		<?php
        		$getdata = mysqli_query($conn,"SELECT * FROM services WHERE servic = 'investments' ");
					...
					<div class="col-lg-6">
						<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
							<div class="feature-box-info">
								<!--<img src="img/demos/medical/gallery/investment.jpg"  alt="" class="float-right ml-sm-4 mb-4 img-fluid box-shadow-custom">-->
		...
		<!--============= Plans your Investment Section End ===============-->
			...
			<div class="container">
				<div class="row mt-4">
					<div class="col-lg-6">
						<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
							<div class="feature-box-info">
								<img src="img/demos/medical/gallery/investment2.jpg"  alt="" class="float-right ml-sm-4 mb-4 img-fluid box-shadow-custom">
							</div>
						</div>
					</div>
					<div class="col-lg-6">
