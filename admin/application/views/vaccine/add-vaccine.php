               ...
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     <div class="ms-panel-header ms-panel-custome">
                        <h6>Add Vaccine</h6>
                        <a href="<?php echo base_url();?>index.php/Vaccinecontroller/vaccine_list" class="ms-text-primary">Vaccine List</a>
                     </div>
                      <?php
                        if(isset($_SESSION['vaccine_added'])){ ?>
                            <div class="alert alert-success alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Success!</strong> <?= $_SESSION['vaccine_added'];?>
                            </div>
                        <?php
                        }
                        unset($_SESSION['vaccine_added']);
                      ?>
                      <?php
                        if(isset($_SESSION['vaccine_failed'])){ ?>
                            <div class="alert alert-danger alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Success!</strong> <?= $_SESSION['vaccine_failed'];?>
                            </div>
                        <?php
                        }
                        unset($_SESSION['vaccine_failed']);
                      ?>

                      <?php
                        if(isset($_SESSION['vaccine_existed'])){ ?>
                            <div class="alert alert-warning alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Success!</strong> <?= $_SESSION['vaccine_existed'];?>
                            </div>
                        <?php
                        }
                        unset($_SESSION['vaccine_existed']);
                      ?>
                      
                     <div class="ms-panel-body">
                        <form action="<?php echo base_url();?>index.php/Vaccinecontroller/addvaccine_process" method="post" class="needs-validation" novalidate>
                           <div class="form-row">
                              <div class="col-md-6 mb-3">
                                 <label for="validationCustom001">Vaccine Name</label>
                                 <div class="input-group">
                                    <input type="text" class="form-control" name="vaccine_name" id="validationCustom001" placeholder="Enter Vaccine Name"  required>
                                  </div>
                              </div>
                              <div class="col-md-6 mb-3">
                                 <label for="validationCustom002">Age Required</label>
                                 <div class="input-group">
                                    <select class="form-control" name="age" id="validationCustom002" placeholder="Enter Age"  required>
                           ...
                           <div class="form-row">
                              <div class="col-md-12 mb-2">
                                 ...
                                 <div class="input-group">
                                    <textarea class="form-control" name="vaccine_desc" required id="exampleTextarea" rows="3"></textarea>
                                  </div>
                              </div>
                           </div>
