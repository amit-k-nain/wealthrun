          ...
          <div class="col-xl-12">
            <div class="ms-panel">
              <div class="ms-panel-header  ms-panel-custome">
                <h6>Vaccine List</h6>
                <a href="<?php echo base_url();?>index.php/Vaccinecontroller/add_vaccine" class="ms-text-primary">Add Vaccine</a>
              </div>
                ...
                <div class="table-responsive">
                    <table id="dtBasicExample" class="table table-striped thead-primary w-100 dataTable no-footer" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th class="th-sm">#</th>
                          <th class="th-sm">Vaccine Name</th>
                          <th class="th-sm">Age</th>
                          <th class="th-sm">Vaccine Description</th>
                      ...
                      <tbody>
                        <?php $a=1;
                        if(isset($vaccine_details)){
                          foreach ($vaccine_details as $vacc_det) {
                          $vaccinname = $vacc_det->vaccine_name; 
                          $vaccinage = $vacc_det->age;
                          $vaccinstatus = $vacc_det->status; 
                          $vaccinsdescr = $vacc_det->vaccine_description; 
                          ?>
                            <tr>
                              <td><?= $a;?></td>
                              <td><?= $vaccinname;?></td>
