               ...
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     ...
                     <div class="ms-panel-body">
                        <form action="<?php echo base_url();?>index.php/Documentcontroller/blog_process" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
							<div class="form-row">
								<div class="col-md-6 mb-3">
									...
									<div class="input-group">
										<select name="cat" id="cat" class="form-control">
											...
											<option value="Start Your Business">Start Your Business</option>
											<option value="Plan Investments">Plan Investments</option>
										</select>
									</div>
								</div>
							</div>
                           ...
                           <div class="form-row">
                              <div class="col-md-12 mb-3">
                                 ...
                                 <div class="input-group">
                                    <textarea name="content" id="content" rows="6" class="form-control ckeditor" required></textarea>
                                  </div>
                              </div>
                           </div>
