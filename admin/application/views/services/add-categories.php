               ...
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     ...
                     <div class="ms-panel-body">
                        <form action="<?php echo base_url();?>index.php/Servicescontroller/addcategories_process" method="post" class="needs-validation" novalidate>
                           <div class="form-row">
                              <div class="col-md-6 mb-3">
                                 <label for="validationCustom001">Add Category</label>
                                 <div class="input-group">
                                    <input type="text" name="s_category" required class="form-control">
                                  </div>
                              </div>
