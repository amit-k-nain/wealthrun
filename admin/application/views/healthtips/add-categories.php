               ...
               <div class="col-md-12">
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Health Categories</li>
                     </ol>
                  </nav>
               </div>
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     <div class="ms-panel-header ms-panel-custome">
                        <h6>Add Health Categories</h6>
                        <a href="<?php echo base_url();?>index.php/Healthtipscontroller/healthtipscategories_list" class="ms-text-primary">Health Categories List</a>
                     </div>
                      <?php
                     ...
                     <div class="ms-panel-body">
                        <form action="<?php echo base_url();?>index.php/Healthtipscontroller/addcategories_process" method="post" class="needs-validation" novalidate>
                           <div class="form-row">
