        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Health Tips List</li>
            </ol>
          </nav>
        </div>
          <div class="col-xl-12">
            <div class="ms-panel">
              <div class="ms-panel-header  ms-panel-custome">
                <h6>Health Tips List</h6>
                <a href="<?php echo base_url();?>index.php/Healthtipscontroller/add_healthtips" class="ms-text-primary">Add Health Tips</a>
              </div>
              <div class="ms-panel-body">
                <div class="table-responsive">
                    <table id="dtBasicExample" class="table table-striped thead-primary w-100 dataTable no-footer" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php $a=1;
                          if(isset($health_tips) && isset($health_categ)){
                            foreach ($health_tips as $htips) {
                              $categ_id = $htips->category_id;
                              $htip_title = $htips->health_tip_title;
                              $htip_img = $htips->tip_img;
                              $htip_desc = $htips->health_tip_desc;
                              $htip_status = $htips->status; 

                              foreach ($health_categ as $categg) {
                                $catgid = $categg->id;
                                if($categ_id == $catgid){
                                  $categnam = $categg->category_name;
                                }
                              }
                              ?>
                            <tr>
                              ...
                              <td><?= $categnam;?></td>
                              <td><?= $htip_title;?></td>
                              <td><img src="<?php echo base_url();?>assets/img/healthtip/<?php echo $htip_img?>"></td>
                              <td><?= $htip_desc;?></td>
                              <?php
                                if($htip_status == 1){ ?>
