...
<!-- Mirrored from slidesigma.com/themes/html/mednalytics/pages/doctor/doctor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Jan 2020 12:21:22 GMT -->
<head>
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            if(isset($doc_details)){
              foreach ($doc_details as $docdetails) { 
                $docid = $docdetails->doc_id;
                $docname = $docdetails->doc_name;
                $docdesig = $docdetails->designation;
                $docaddress = $docdetails->doc_address;
                $docaimg = $docdetails->doc_img;
            ?>
                ...
                <div class="ms-card-body">
                  <div class="media fs-14">
                    <div class="mr-2 align-self-center">
                      <img src="../../assets/img/doctor/<?=$docaimg;?>" class="ms-img-round" alt="people">
                    </div>
                    ...
                    <div class="media-body">
                      ...
                      <div class="dropdown float-right">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                          <li class="ms-dropdown-list">
                            ...
                            <a class="media p-2" href="#"><div class="media-body"><span>View Details</span></div>
                            </a>

                            <a class="media p-2" href="#"><div class="media-body"><span>Assign</span>
                            </div></a>

                            <a class="media p-2" href="#"><div class="media-body"><span>Edit</span></div></a>

                            <a class="media p-2" href="#"><div class="media-body"><span>Delete</span>
                            </div>
                            </a>
                      ...
                      <p class="fs-12 my-1 text-disabled"><?= $docdesig;?></p>
                      <h6 class="mt-2"><span class="fs-14"><i class="fas fa-map-marker-alt"></i></span><?= $docaddress;?></h6>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from slidesigma.com/themes/html/mednalytics/pages/doctor/doctor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Jan 2020 12:21:34 GMT -->
</html>
