               ...
               <div class="col-md-12">
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb pl-0">
                        ...
                        <li class="breadcrumb-item"><a href="#">Documnets</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Documnets</li>
                     </ol>
                  </nav>
               </div>
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     <div class="ms-panel-header ms-panel-custome">
                        <h6>Add Document</h6>
                        <a href="<?php echo base_url();?>index.php/Documentcontroller/document_list" class="ms-text-primary">Document List</a>
                     </div>
                      <?php
                     ...
                     <div class="ms-panel-body">
                        <form action="<?php echo base_url();?>index.php/Documentcontroller/adddocument_process" method="post" class="needs-validation" novalidate>
                           <div class="form-row">
                              <div class="col-md-6 mb-3">
                                 <label for="validationCustom001">Add Document</label>
                                 <div class="input-group">
                                    <input type="text" name="doc_name" required class="form-control">
                                  </div>
                              </div>
