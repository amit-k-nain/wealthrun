			...
			<div class="col-md-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb pl-0">
						...
						<li class="breadcrumb-item active" aria-current="page">Edit Video URLs</li>
					</ol>
				</nav>
			</div>
			<div class="col-xl-12 col-md-12">
				<div class="ms-panel">
					...
					<div class="ms-panel-body">
						<form action="<?php echo base_url();?>index.php/Documentcontroller/video_process" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
							<div class="form-row">
								<div class="col-md-12 mb-3">
									<label for="content">URLs (Comma Separated)</label>
									<div class="input-group">
										<input type="text" name="content" id="content" placeholder="URLs (Comma Separated)" value="<?php echo (isset($video[0]) && $video[0]) ? $video[0]->content : ''; ?>" required class="form-control">
									</div>
								</div>
							</div>
