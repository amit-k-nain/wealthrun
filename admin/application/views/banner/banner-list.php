          ...
          <div class="col-xl-12">
            <div class="ms-panel">
              <div class="ms-panel-header  ms-panel-custome">
                <h6>Banners</h6>
                <a href="<?php echo base_url();?>index.php/Documentcontroller/add_banner" class="ms-text-primary">Add Banner</a>
              </div>
                            ...
                            if(isset($banners)){
                                ...
                                ?>
                                    <tr>
                                      ...
                                      <td><?=$title2?></td>
                                      <td><?=$title3?></td>
                                      <td><img alt="WealthRun" src="<?=base_url()?>/assets/img/banner/<?=$bannerImage?>"></td>
                                      <?php
                                      if($status == 1){?>
                                      ...
                                      ?>
										<td><?=$update?></td>
										<td>
											<a href='<?php echo base_url();?>index.php/Documentcontroller/banner_update?bid=<?php echo $id;?>'><i class='fas fa-pencil-alt ms-text-primary'></i></a>
