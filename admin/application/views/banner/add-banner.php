               ...
               <div class="col-xl-12 col-md-12">
                  <div class="ms-panel">
                     <div class="ms-panel-header ms-panel-custome">
                        <h6>Add Banner</h6>
                        <a href="<?php echo base_url();?>index.php/Documentcontroller/banner_list" class="ms-text-primary">Banners List</a>
                     </div>
                      <?php
                     ...
                     <div class="ms-panel-body">
                        <form action="<?php echo base_url();?>index.php/Documentcontroller/banner_process" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
							<div class="form-row">
                              <div class="col-md-6 mb-3">
                                 <label for="title1">Title 1</label>
                                 <div class="input-group">
                                    <input type="text" placeholder="Title 1" name="title1" id="title1" class="form-control">
                                  </div>
                              </div>
								<div class="col-md-6 mb-3">
                                 <label for="title2">Title 2</label>
                                 <div class="input-group">
                                    <input type="text" placeholder="Title 2" name="title2" id="title2" class="form-control">
                                  </div>
                              </div>
								<div class="col-md-6 mb-3">
                                 <label for="title3">Title 3</label>
                                 <div class="input-group">
                                    <input type="text" placeholder="Title 3" name="title3" id="title3" class="form-control">
                                  </div>
                              </div>
