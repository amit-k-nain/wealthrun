			...
			<div class="col-xl-12 col-md-12">
				<div class="ms-panel">
					...
					<div class="ms-panel-body">
						<form action="<?php echo base_url();?>index.php/Userscontroller/user_profile_process" method="post" class="needs-validation" novalidate>
							<div class="form-row">
								<div class="col-md-6 mb-3">
									<label for="name">Name *</label>
									<div class="input-group">
										<input type="text" name="name" id="name" placeholder="Name" value="<?=$user[0]->full_name?>" required class="form-control">
									</div>
								</div>
								...
								<div class="col-md-6 mb-3">
									...
									<div class="input-group">
										<input type="tel" name="mobile" id="phone" placeholder="Phone" value="<?=$user[0]->mobile?>" required class="form-control">
									</div>
								</div>
							</div>
							<div class="form-row">
								<div class="col-md-6 mb-3">
									...
									<div class="input-group">
										<input type="email" readonly id="email" placeholder="Email" value="<?=$user[0]->email?>" required class="form-control">
									</div>
								</div>
								<div class="col-md-6 mb-3">
									<label for="password">Password *</label>
									<div class="input-group">
										<input type="text" name="password" id="password" placeholder="Password" value="<?=$user[0]->password?>" required class="form-control">
									</div>
								</div>
							</div>
