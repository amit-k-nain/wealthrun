...
var dataSet = [
  ...
  var dataSet1 = [
      [ "1",  "Dentists","Daniel", "<span class='badge badge-outline-success'>Active</span>",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "2",  "Neurology","Joshua", "<span class='badge badge-outline-danger'>Inactive</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "3",  "Opthalmology","Jenni", "<span class='badge badge-outline-danger'>Inactive</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "4",  "Orthopedics","Daniel", "<span class='badge badge-outline-success'>Active</span>",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "5",  "Cancer Department","Jacob", "<span class='badge badge-outline-danger'>Inactive</span>", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "6",  "ENT Department","Adwerd", "<span class='badge badge-outline-danger'>Inactive</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "7",  "General Surgery","Kyle", "<span class='badge badge-outline-success'>Active</span>", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "8",  "Heart Surgery","Paul", "<span class='badge badge-outline-danger'>Inactive</span>",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "9",  "Radiotherapy","Patrick", "<span class='badge badge-outline-success'>Active</span>",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "10", "Cancer Department","Sandra", "<span class='badge badge-outline-danger'>Inactive</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "11", "Gynaecology","Denis", "<span class='badge badge-outline-success'>Active</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "12", "Orthopedics","Bella", "<span class='badge badge-outline-danger'>Inactive</span>", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "13", "Heart Surgery","Henry", "<span class='badge badge-outline-success'>Active</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      [ "14", "Neurology", "Linda","<span class='badge badge-outline-success'>Active</span>",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
