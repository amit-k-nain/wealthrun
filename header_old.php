				...
				<div class="header-column">
					<div class="header-row">
						<div class="header-logo">
							<a href="index.php">
								<img class="wr-logo" id="main_logo" alt="wealthrun" height="75px" src="img/wr-logo.png">
									...
									<ul class="nav nav-pills" id="mainNav">
										...
										<li class="dropdown dropdown-full-color dropdown-secondary">
											...
											<ul class="dropdown-menu">
												<li><a class="dropdown-item" href="income-tax.php">Income Tax Return (ITR)</a></li>
												<li><a class="dropdown-item" href="plan-investment.php">Plan Your Investments/Tax </a></li>
												<li><a class="dropdown-item" href="tds-and-tcs.php">Deducted Collected at Source (TDS & TCS) </a></li>
												<li><a class="dropdown-item" href="gst.php">GST </a></li>
												<li><a class="dropdown-item" href="start-business.php">Start Your Business </a></li>
										...
										<?php
        									...
        									<?php
        										...
        										<li class="nav-item nav-item-borders py-2 pr-1 d-none d-md-inline-flex">
        											<a href="#myModal" data-toggle="modal" data-target=".log-sign" class="btn btn-primary btn-sigup"><i class="far fa-user text-4 text-color-primary" style="top: 1px;"></i>&nbsp; SignUp/SigIn</a>
        										</li>
        									<?php
        									}
        								?>
                        ...
                        <form class="form-horizontal" action="action/signup_process.php" method="post">
                            <fieldset>
                                ...
                                <div class="group2">
                                    ...
                                    <span class="highlight"></span><span class="bar"></span>
                                    <label class="label" for="date">Mobile No.</label>
                                </div>
