...
<head>
    ...
    <title>Start your Business/Start-up | WealthRun</title>
    <meta name="description" content="Wealthrun - Start Your Business">
    <!-- Favicon -->
...
<div class="body">
    ...
    <div role="main" class="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                        <h1>Start your Business / Start-up</h1>
                    </div>
                    <div class="col-md-4 order-1 order-md-2 align-self-center">
                        <ul class="breadcrumb d-block text-md-right breadcrumb-light">
                            <li><a href="index.php">Home</a></li>
                            <li class="active">Services</li>
                            <li class="active">Start your Business/Start-up</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="group m-l-0">
                                            ...
                                            <select required name="service_id" class="inputMaterial">
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM services WHERE cat = 'Start Your Business'";
        ...
        <?php
        $sql1 = "SELECT * FROM service_content WHERE cat = 'Start Your Business' AND servic = 'Start Your Business'";
        ...
        <?php
        $sqlp = "SELECT * FROM `blogs` WHERE `status`= 1 AND `cat` = 'Start Your Business' order by `id` desc limit 0,6";
