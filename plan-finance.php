...
<head>
	...
	<title>Plan Your Finance | Income Tax Return</title>	
    ...
    <!--==================== Header Section End =====================-->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
						<h1>Plan Your Finance <br><span>Everything you need to know</span></h1>
					</div>
					<div class="col-md-4 order-1 order-md-2 align-self-center">
						<ul class="breadcrumb d-block text-md-right breadcrumb-light">
							<li><a href="index.html">Home</a></li>
							<li class="active">Resources</li>
							<li class="active">Plan your finance</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row mt-5 mb-5">
				<div class="col">
					<h2 class="font-weight-semibold mb-3">Plan Your Finance</h2>
					...
					<div class="row mt-4">
						<div class="col-md-4 mb-3 mb-md-0">
							<a href="#" class="text-decoration-none">
								<img alt="" class="img-fluid" src="img/demos/medical/gallery/p1.jpg">
							</a>
						</div>
						<div class="col-md-8">
							<h4 class="font-weight-semibold mb-1 mt-1">
								<a href="#" class="text-decoration-none">Personal Finance</a>
							</h4>
							...
							<p><a href="#" class="btn btn-outline btn-quaternary custom-button text-uppercase mt-2 mb-3 font-weight-bold btn-md text-1">view more...</a></p>
						</div>
					</div>
					<div class="row mt-4">
						<div class="col-md-4 mb-3 mb-md-0">
							<a href="#" class="text-decoration-none">
								<img alt="" class="img-fluid" src="img/demos/medical/gallery/p2.jpg">
							</a>
						</div>
						<div class="col-md-8">
							<h4 class="font-weight-semibold mb-1 mt-1">
								<a href="#" class="text-decoration-none">Time to plan</a>
							</h4>
							<p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat...</p>
							<p><a href="#" class="btn btn-outline btn-quaternary custom-button text-uppercase mt-2 mb-3 font-weight-bold btn-md text-1">view more...</a></p>
						</div>
					...
					<div class="row mt-4">
						<div class="col-md-4 mb-3 mb-md-0">
							<a href="#" class="text-decoration-none">
								<img alt="" class="img-fluid" src="img/demos/medical/gallery/p3.jpg">
							</a>
						</div>
						<div class="col-md-8">
							<h4 class="font-weight-semibold mb-1 mt-1">
								<a href="#" class="text-decoration-none">Backup plan</a>
							</h4>
							<p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat...</p>
							<p><a href="#" class="btn btn-outline btn-quaternary custom-button text-uppercase mt-2 mb-3 font-weight-bold btn-md text-1">view more...</a></p>
						</div>
